namespace DataCollector
{
    ...
    internal class Data
    {
        ...
        ///     The allies.
        /// </value>
        public IEnumerable<OtherHeroData> Allies
            =>
            ObjectManager.Get<Obj_AI_Hero>()
                .Where(x => x.Team == this.Team && x.NetworkId != this.NetworkId)
                .Select(x => OtherHeroData.CreateFromHero(x));
        ...
        ///     The enemies.
        /// </value>
        public IEnumerable<OtherHeroData> Enemies
            =>
            ObjectManager.Get<Obj_AI_Hero>()
                .Where(x => x.Team != this.Team && x.NetworkId != this.NetworkId)
                .Select(x => OtherHeroData.CreateFromHero(x));
        ...
        /// <returns></returns>
        public static Data CreateFromHero(Obj_AI_Hero hero, Vector2 position = new Vector2())
        {
